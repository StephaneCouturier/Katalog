...
/////////////////////////////////////////////////////////////////////////////
// Application: Katalog
// File Name:   DeviceMappingView.h
// Purpose:     Class/model to display a mapping of devices
// Description:
// Author:      Stephane Couturier
/////////////////////////////////////////////////////////////////////////////
*/
#ifndef DEVICEMAPPINGVIEW_H
#define DEVICEMAPPINGVIEW_H

#include <QSortFilterProxyModel>
#include <QList>

class DeviceMappingView  : public QSortFilterProxyModel
{
    Q_OBJECT

public:
    DeviceMappingView(QObject *parent = nullptr);
