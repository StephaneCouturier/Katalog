...
// Placeholder for getDeviceFromIndex if it doesn't exist
/*
Device* MainWindow::getDeviceFromIndex(const QModelIndex& index)
{
    // Implement this based on your existing tree view model
